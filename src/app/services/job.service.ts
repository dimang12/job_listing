...
export class JobService {
  ...
  getJobs_all(){
    return [
      {"id":1, "title":"getJobs_all","city":"Oakland","job_type":"data management","salary":1000,"summary":"this is blue blue","duty":"guard","requirement":"diploma"},
      {"id":2, "title":"getJobs_all","city":"Oakland","job_type":"data management","salary":1000,"summary":"this is blue blue","duty":"guard","requirement":"diploma"},
      {"id":3, "title":"getJobs_all","city":"Oakland","job_type":"data management","salary":1000,"summary":"this is blue blue","duty":"guard","requirement":"diploma"},
      {"id":4, "title":"getJobs_all","city":"Oakland","job_type":"data management","salary":1000,"summary":"this is blue blue","duty":"guard","requirement":"diploma"},
      {"id":5, "title":"getJobs_all","city":"Oakland","job_type":"data management","salary":1000,"summary":"this is blue blue","duty":"guard","requirement":"diploma"},
      {"id":6, "title":"getJobs_all","city":"Oakland","job_type":"data management","salary":1000,"summary":"this is blue blue","duty":"guard","requirement":"diploma"}
  ];
  }
